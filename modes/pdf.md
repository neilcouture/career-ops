...
If the candidate has a live demo/dashboard (check profile.yml), include the URL in the Professional Summary for relevant roles.

## Post-generation

Update tracker if the offer is already registered: change PDF from [x] to [check].
